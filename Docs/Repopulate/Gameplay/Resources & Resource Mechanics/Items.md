Below is a non-exhaustive list of items, and what they do on the station. Many items will have different layers of efficiency, not all layers will be listed to keep things concise.
