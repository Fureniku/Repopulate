...
namespace Repopulate.Physics.Gravity {
    public abstract class GravityBase : MonoBehaviour {
        ...
        public Vector3 GetPull(Vector3 pulledObject) {
            return GetPullDirection(pulledObject) * _gravity.magnitude;
        }
        ...
        /* TODO are these used? Brought in from GravitySourcePoint but seem unused. Delete if we've not found a use by the next time I see this comment.
        public Vector3 GetGravity() {
            return _gravity;
        }

        public float GetMagnitude() {
            return _gravity.magnitude;
        }*/
    }
}
