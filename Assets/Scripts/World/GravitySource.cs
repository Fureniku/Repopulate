...
public class GravitySource : MonoBehaviour {
	...
	//Debug:
	private Vector3 closestPoint; //The last returned closest point, to update the gizmo position
	private Color gizmoCol = Color.magenta; //Variable to change gizmo colour when player is within gravitational range
	...
	public bool IsWithinGravitationalEffect(Vector3 pulledObject) {
